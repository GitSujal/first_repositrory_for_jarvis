...
def temperatureSuggestion(temp):
	...
	if 0 > temp :
		...
		string = "It's hot today, so I'd suggest shorts and a t-shirt. "
	elif (25<=temp)and (temp<30):
		string = "It's very hot today, so I'd suggest wearing the least amount of clothes you can. "
	elif 30 <= temp:
		string = "It's blazing hot today. I'd go naked if I were you. "
